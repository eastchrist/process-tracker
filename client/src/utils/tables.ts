...
export const  getDesignElementUiHeaderStyle = ( rowIndex: number, columnIndex: number, designTable: ITableDataUiDesignedWithData, totalRow: number) => {
    ...
    if (rowIndex === 0) {
        return {
            ...
            "font-weight": designTable.title.font.weight,
    ...
    //Header First column
        ...
        if (columnIndex === 0) {
            return {
                ...
                "font-weight": designTable.header.font.weight,
            ...
            if (rowIndex == 0) {
                ...
                if (totalRow === 1) {
                    return {
                        ...
                        "font-weight": designTable.columns.design[columnIndex].font.weight,
    ...
    //Header
        ...
        if (columnIndex === 0) {
            return {
                ...
                "font-weight": designTable.headerSub.font["weight"],
