<template>
    <div class="factoryCartoProject-container">
        <TableAllUserProject :idFactory=idFactory :isAdmin=isAdmin :isManagerEdit=isManagerEdit :isManager=isManager :isOperator=isOperator></TableAllUserProject>
    </div>
</template>
