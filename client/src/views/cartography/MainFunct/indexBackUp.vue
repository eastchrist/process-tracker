<template>
    <div class="table-overviewFonctionBackUp">
        <div class="wrapper">
            <div class="hea01">Header 1 Main Information</div>
            <div class="tabTest">
                <!-- <carto-main-table-test ></carto-main-table-test> -->
...
<style lang="scss" scoped>
    .wrapper{
        ...
        grid-template-areas:
                ...
                "tabTest tabTest tabTest tabTest tabTest .     tab01 tab01 tab01 tab01 tab01 tab01 "
                "tabTest tabTest tabTest tabTest tabTest .     tab01 tab01 tab01 tab01 tab01 tab01 "
                "tabTest tabTest tabTest tabTest tabTest .     tab01 tab01 tab01 tab01 tab01 tab01 "
