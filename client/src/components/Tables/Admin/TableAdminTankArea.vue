<template>
    <div class="table-container">
        <div class="wrapper">
            <div class="filter">
                <el-input v-model="listQuery.name" :placeholder="$t('tables.tankArea.placeholder.placeholder1')" class="filter-item" @keyup.enter.native="handleFilter"/>
                <el-select v-model="listQuery.idArea" :placeholder="$t('tables.tankArea.placeholder.placeholder2')" clearable class="filter-item" >
            ...
            <div class="extra">
                ...
                <ImportFromExcel class="ImportFromExcel" className="ImportFromExcel" TableName="TankArea" :TableList=list :defaultExcelHeader="listExcel" :on-success="handleSuccess" :before-upload="beforeUpload"></ImportFromExcel>
...
<script lang="ts">
    ...
    import { getDBTankAreas, updateDBTankAreas, updateDBTankArea, deleteDBTankArea, defaultTankAreaData, defaultTankAreaRules, defaultTankAreaQuery, defaultTankAreaExcelHeader} from '@/api/tankAreas'
    ...
    export default class Dashboard extends Vue {
        private designTable: ITableDataUiDesignedWithoutData = defaultTankAreaDesignTable
        ...
        private listExcel = defaultTankAreaExcelHeader
