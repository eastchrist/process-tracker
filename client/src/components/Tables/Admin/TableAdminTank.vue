<template>
    <div class="table-container">
        <div class="wrapper">
            <div class="filter">
                <el-input v-model="listQuery.name" :placeholder="$t('tables.tank.placeholder.placeholder1')" class="filter-item" @keyup.enter.native="handleFilter"/>
            ...
            <div class="extra">
                ...
                <ImportFromExcel class="ImportFromExcel" className="ImportFromExcel" TableName="Tank" :TableList=list :defaultExcelHeader="listExcel" :on-success="handleSuccess" :before-upload="beforeUpload"></ImportFromExcel>
...
<script lang="ts">
    ...
    import { getDBTanks, updateDBTanks, updateDBTank, deleteDBTank, defaultTankData, defaultTankRules, defaultTankQuery, defaultTankExcelHeader } from '@/api/tanks'
    ...
    export default class Dashboard extends Vue {
        private designTable: ITableDataUiDesignedWithoutData = defaultTankDesignTable
        ...
        private listExcel = defaultTankExcelHeader
