<template>
    <div class="table-container">
        <div class="wrapper">
            <div class="filter">
                <el-input v-model="listQuery.name" :placeholder="$t('tables.server.placeholder.placeholder1')" class="filter-item" @keyup.enter.native="handleFilter"/>
            ...
            <div class="extra">
                ...
                <ImportFromExcel class="ImportFromExcel" className="ImportFromExcel" TableName="Server" :TableList=list :defaultExcelHeader="listExcel" :on-success="handleSuccess" :before-upload="beforeUpload"></ImportFromExcel>
...
<script lang="ts">
    ...
    import { getDBServers, updateDBServers, updateDBServer, deleteDBServer, defaultServerData, defaultServerRules, defaultServerQuery, defaultServerExcelHeader } from '@/api/servers'
    ...
    export default class Dashboard extends Vue {
        private designTable: ITableDataUiDesignedWithoutData = defaultServerDesignTable
        ...
        private listExcel = defaultServerExcelHeader
