<template>
    <div class="table-container">
        <div class="wrapper">
            <div class="filter">
                <el-input v-model="listQuery.name" :placeholder="$t('tables.projectAction.placeholder.placeholder1')" class="filter-item" @keyup.enter.native="handleFilter"/>
            ...
            <div class="extra">
                ...
                <ImportFromExcel class="ImportFromExcel"  className="ImportFromExcel" TableName="ProjectAction" :TableList=list :defaultExcelHeader="listExcel" :on-success="handleSuccess" :before-upload="beforeUpload"></ImportFromExcel>
            </div>
            <div class="table">
                <!--  <el-table  -->
                <!-- Design Table    -->
...
<script lang="ts">
    ...
    import { getDBProjectActions, updateDBProjectActions, updateDBProjectAction, deleteDBProjectAction, defaultProjectActionData, defaultProjectActionRules, defaultProjectActionQuery, defaultProjectActionExcelHeader } from '@/api/projectActions'
    ...
    export default class Dashboard extends Vue {
        private designTable: ITableDataUiDesignedWithoutData = defaultProjectActionDesignTable
        ...
        private listExcel = defaultProjectActionExcelHeader
