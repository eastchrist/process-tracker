    ...
    <div class="table-container">
        <div class="wrapper">
            ...
            <div class="extra">
                ...
                <ImportFromExcel class="ImportFromExcel" className="ImportFromExcel" TableName="ProjectStatus" :TableList=list :defaultExcelHeader="listExcel" :on-success="handleSuccess" :before-upload="beforeUpload"></ImportFromExcel>
            </div>
            <div class="table">
                <!--  <el-table  -->
...
<script lang="ts">
    ...
    import { getDBProjectStatus, updateDBProjectStatuss, deleteDBProjectStatus, defaultProjectStatusData, defaultProjectStatusQuery, defaultProjectStatusExcelHeader } from '@/api/projectStatus'
    ...
    export default class Dashboard extends Vue {
        private designTable: ITableDataUiDesignedWithoutData = defaultProjectStatusDesignTable
        ...
        private listExcel = defaultProjectStatusExcelHeader
