<template>
    <el-dialog :class="className" :title="title" :visible.sync="dialogFormVisible" :before-close="beforeClose">
        <el-form ref="dataForm" :rules="rules" :model="tempData" label-position="left" label-width="200px" style="width: 400px; margin-left:50px;">
            <el-form-item :label="$t('tables.dataProject.edit.champs3')" prop="comment">
                <el-input v-model="tempData.comment" />
            </el-form-item>

            <el-form-item :label="$t('tables.dataProject.edit.champs4')" prop="creationDate">
                <el-date-picker v-model="tempData.creationDate" type="datetime" placeholder="Please pick a date"/>
            </el-form-item>
            <el-form-item :label="$t('tables.dataProject.edit.champs5')" prop="dueDate">
                <el-date-picker v-model="tempData.dueDate" type="datetime" placeholder="Please pick a date"/>
            </el-form-item>

            <el-form-item :label="$t('tables.dataProject.edit.champs6')" prop="idProject">
                <el-input v-model="tempData.idProject" />
            </el-form-item>

            <el-form-item :label="$t('tables.dataProject.edit.champs7')" prop="status">
