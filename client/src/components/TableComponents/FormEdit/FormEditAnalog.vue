<template>
    <el-dialog :class="className" :title="title" :visible.sync="dialogFormVisible" :before-close="beforeClose">
        <el-form ref="dataForm" :rules="rules" :model="tempData" label-position="left" label-width="200px" style="width: 400px; margin-left:50px;">
            ...
            <el-form-item :label="$t('tables.analog.edit.champs3')" prop="name">
                <el-input v-model="tempData.name" />
            </el-form-item>
            <el-form-item :label="$t('tables.analog.edit.champs4')" prop="name1">
                <el-input v-model="tempData.name1" />
            </el-form-item>
            <el-form-item :label="$t('tables.analog.edit.champs5')" prop="tag">
                <el-input v-model="tempData.tag" />
            </el-form-item>
            <el-form-item :label="$t('tables.analog.edit.champs6')" prop="address">
                <el-input v-model="tempData.address" />
            </el-form-item>
            <el-form-item :label="$t('tables.analog.edit.champs7')" prop="type">
                <el-input v-model="tempData.type" />
            </el-form-item>
            <el-form-item :label="$t('tables.analog.edit.champs8')" prop="idEquip">
                <el-input v-model="tempData.idEquip" />
            </el-form-item>
            <el-form-item :label="$t('tables.analog.edit.champs9')" prop="idTank">
                <el-input v-model="tempData.idTank" />
            </el-form-item>
            <el-form-item :label="$t('tables.analog.edit.champs10')" prop="indexCreation">
